...
EOF
    ...
    expected_output="$current/assn5_tmpdsh2>dsh2>dsh2>cmdloopreturned0"
...
EOF
    ...
    expected_output="dsh2>ERR:toomanyargsforcdcommanddsh2>cmdloopreturned0"
...
EOF
    ...
    expected_output="cderror:Nosuchfileordirectorydsh2>dsh2>cmdloopreturned0"
...
EOF
    ...
    expected_output="dsh2>exiterror:commandtakesnoargsdsh2>cmdloopreturned0"     
