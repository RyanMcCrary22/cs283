...
3. Please provide a link to the repository you are using for this class.
	I will be using [This repository](https://github.com/RyanMcCrary22/cs283.git) for the course.

4. Briefly describe what you want to get out of this class.
	I want to get a better understanding of systems programming overall, and especially learn the details of what is
	going on in my computer when I am opening and shifting between different applications. 

5. Briefly describe any concerns you might be having with being successful in this class (if any).
	I am very unexperienced with Git and Github so I fear it might slow me down some in this course, but I am also happy
	that I am being forced to work with it because I know it is going to be a vital skill for me to have. 
